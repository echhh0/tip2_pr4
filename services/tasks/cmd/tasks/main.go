...
import (
	...
	"tip2_pr4/services/tasks/internal/client/authclient"
	httpapi "tip2_pr4/services/tasks/internal/http"
	"tip2_pr4/services/tasks/internal/service"
	sharedlogger "tip2_pr4/shared/logger"
	"tip2_pr4/shared/metrics"
	"tip2_pr4/shared/middleware"
...
func main() {
	...
	app := middleware.RequestID(metrics.InstrumentHTTP(middleware.AccessLog(logger)(mux)))
